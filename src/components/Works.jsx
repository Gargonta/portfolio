      ...
      <>
        ...
        <div className='w-full flex'>
          ...
          >
              ...
              реальные примеры моей работы. Каждый проект описан с помощью
              ссылки. Это отражает мой способность решать сложные задачи, работать с различными технологиями
